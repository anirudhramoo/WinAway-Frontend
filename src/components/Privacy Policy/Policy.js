...
const Policy = () => {
  return (
    <div className="outer-policy">
      <h1> Winaway Privacy Policy</h1>
      <p>Last updated: April 07, 2021</p>
      <p>
        This Privacy Policy describes our policies and procedures on the
        collection, use and disclosure of your information when You use this
        Service and tells You about your privacy rights and how the law protects
        You.
      </p>
      <p>
        We use Your Personal data as part of this service. By using this
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WinAway.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Service</strong> refers to the Website registered under the
            domain winaway.tech.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WinAway, accessible from{" "}
            <a
              href="https://winaway.tech"
      ...
      <p>
        ...
        such as your name, your email address, or your activities .
      </p>
      <p>
      ...
      <ul>
        <li>By email: anirudh.ramp@gmail.com</li>
      </ul>
    </div>
  );
};
